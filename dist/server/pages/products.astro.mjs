...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const subTitle = "Explore the durability and precision of Peshawari Chappal tools, designed for both professionals and enthusiasts. Each of our products is crafted with precision and built to last, ensuring you have the right tool for every job.";
  const testimonials = [
    // First testimonial data
    {
      content: ` "Since switching to Peshawari Chappal's hardware tools, the efficiency on our construction sites has skyrocketed. The durability of the hex bolts and precision of the machine screws are simply unmatched. It's refreshing to work with a company that truly understands the daily demands of the industry." `,
      author: "Jason Clark",
    ...
    {
      content: ` "As an interior designer, I'm always looking for high-quality materials and tools that help bring my visions to life. Peshawari Chappal's mixed screws assortment has been a game-changer for my projects, providing the perfect blend of quality and variety. The outstanding customer support was just the cherry on top!" `,
    ...
    {
      content: ` "I've been a professional carpenter for over 15 years, and I can sincerely say that Peshawari Chappal's tap bolts and nuts are some of the best I've used. They grip like no other, and I have full confidence in every joint and fixture. Plus, the service is impeccable \u2013 they truly care about my project's success." `,
      author: "Richard Kim",
  ...
  const metaDescription = "Explore the durability and precision of Peshawari Chappal tools, designed for both professionals and enthusiasts.";
  const ogTitle = "Hardware Tools | Peshawari Chappal";
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "customDescription": metaDescription, "customOgTitle": ogTitle, "structuredData": {
    ...
    name: "Hardware Tools | Peshawari Chappal",
    description: "Explore the durability and precision of Peshawari Chappal tools, designed for both professionals and enthusiasts.",
    isPartOf: {
      "@type": "WebSite",
  ...
  })} </section> </div> ${renderComponent($$result2, "FeaturesStatsAlt", $$FeaturesStatsAlt, { "title": "Why Choose Peshawari Chappal?", "subTitle": "Transform your ideas into tangible results with Peshawari Chappal tools. Whether you're starting with a sketch on a napkin or diving into a comprehensive construction project, our tools are engineered to help you build with confidence.", "benefits": [
