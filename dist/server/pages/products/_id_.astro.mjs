import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, d as renderTemplate, r as renderComponent, e as renderScript } from '../../chunks/astro/server_B5Ll6kUe.mjs';
import 'kleur/colors';
import { S as SITE, a as $$MainLayout } from '../../chunks/MainLayout_twjl8UOv.mjs';
import 'clsx';
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const ogTitle = `${product.data.title} | Handcrafted Leather Sandals | Peshawari Chappal`;
