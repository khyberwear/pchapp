...
import { r as renderEntry, g as getCollection } from '../../../chunks/_astro_content_BzHMUHez.mjs';
/* empty css                                      */
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "lang": "fr", "customDescription": metaDescription, "customOgTitle": ogTitle, "structuredData": {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://peshawarichappal.store/fr/insights/${post.id.replace(/^fr\//, "")}`
    },
    inLanguage: "fr"
...
Table of Contents:
</p> <div id="toc" class=""> <ul class="space-y-2 text-base text-pretty text-neutral-700 transition duration-300 dark:text-neutral-400"></ul> </div> </div> </div> <div class="md:pt-8"> <h1 class="mb-4 text-center text-2xl font-bold text-balance text-neutral-800 sm:text-3xl md:mb-6 md:text-left dark:text-neutral-200"> ${post.data.title} </h1> <article class="text-lg text-pretty text-neutral-700 dark:text-neutral-300"> ${renderComponent($$result2, "Content", Content, {})} </article> </div> </div> </div> </section> ` })}  ${renderScript($$result, "/Users/atifjan/PC/pchapp/src/pages/fr/insights/[id].astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result, "/Users/atifjan/PC/pchapp/src/pages/fr/insights/[id].astro?astro&type=script&index=1&lang.ts")}`;
}, "/Users/atifjan/PC/pchapp/src/pages/fr/insights/[id].astro", void 0);

const $$file = "/Users/atifjan/PC/pchapp/src/pages/fr/insights/[id].astro";
