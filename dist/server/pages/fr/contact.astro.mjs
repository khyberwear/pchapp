...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  const ogTitle = "Nous Contacter | Peshawari Chappal";
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "lang": "fr", "customDescription": metaDescription, "customOgTitle": ogTitle, "structuredData": {
    ...
    "@type": "WebPage",
    "@id": "https://peshawarichappal.store/fr/contact",
    url: "https://peshawarichappal.store/fr/contact",
    name: "Nous Contacter | Peshawari Chappal",
...
}, "/Users/atifjan/PC/pchapp/src/pages/fr/contact.astro", void 0);

const $$file = "/Users/atifjan/PC/pchapp/src/pages/fr/contact.astro";
