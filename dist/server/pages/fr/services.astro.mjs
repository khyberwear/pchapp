...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Services | Peshawari Chappal", "lang": "fr", "structuredData": {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://peshawarichappal.store/fr/services",
    url: "https://peshawarichappal.store/fr/services",
    name: "Services de Consultation d'Experts | Peshawari Chappal",
    description: "Unissant l'expertise \xE0 votre vision, Peshawari Chappal fournit un service exceptionnel et des solutions compl\xE8tes dans le secteur du mat\xE9riel et de la construction, de la consultation \xE0 l'ach\xE8vement du projet.",
    isPartOf: {
      "@type": "WebSite",
  ...
  })}${renderComponent($$result2, "FeaturesStats", $$FeaturesStats, { "title": "Par les chiffres", "subTitle": "Notre engagement envers la qualit\xE9 et la fiabilit\xE9 est \xE9vident dans chaque projet que nous entreprenons. Chez Peshawari Chappal, nous nous engageons \xE0 fournir des services de premier plan dans l'industrie qui garantissent que vos projets de construction sont con\xE7us pour durer.", "mainStatTitle": "96%", "mainStatSubTitle": "de nos clients \xE9valuent leur exp\xE9rience avec Peshawari Chappal comme exceptionnelle", "stats": [
    {
      stat: "99,8%",
...
}, "/Users/atifjan/PC/pchapp/src/pages/fr/services.astro", void 0);

const $$file = "/Users/atifjan/PC/pchapp/src/pages/fr/services.astro";
