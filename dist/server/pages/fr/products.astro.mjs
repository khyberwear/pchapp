...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const subTitle = "Explorez la durabilit\xE9 et la pr\xE9cision des outils Peshawari Chappal, con\xE7us aussi bien pour les professionnels que pour les amateurs. Chacun de nos produits est fabriqu\xE9 avec pr\xE9cision et con\xE7u pour durer, garantissant que vous disposez du bon outil pour chaque t\xE2che.";
  const testimonials = [
    {
      content: "Depuis que nous avons adopt\xE9 les outils mat\xE9riels de Peshawari Chappal, l'efficacit\xE9 sur nos chantiers de construction a explos\xE9. La durabilit\xE9 des boulons hexagonaux et la pr\xE9cision des vis machine sont tout simplement in\xE9gal\xE9es. C'est rafra\xEEchissant de travailler avec une entreprise qui comprend vraiment les exigences quotidiennes de l'industrie.",
      author: "Jason Clark",
    ...
    {
      content: "Je suis menuisier professionnel depuis plus de 15 ans, et je peux sinc\xE8rement dire que les boulons et \xE9crous \xE0 tarauder de Peshawari Chappal sont parmi les meilleurs que j'ai utilis\xE9s. Ils adh\xE8rent comme aucun autre, et j'ai une confiance totale dans chaque joint et \xE9l\xE9ment. De plus, le service est impeccable - ils se soucient vraiment du succ\xE8s de mon projet.",
      author: "Richard Kim",
  ...
  const pageTitle = "Produits | Peshawari Chappal";
  const metaDescription = "Explorez la durabilit\xE9 et la pr\xE9cision des outils Peshawari Chappal, con\xE7us aussi bien pour les professionnels que pour les passionn\xE9s.";
  const ogTitle = "Outils Mat\xE9riels | Peshawari Chappal";
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "lang": "fr", "customDescription": metaDescription, "customOgTitle": ogTitle, "structuredData": {
    ...
    "@type": "WebPage",
    "@id": "https://peshawarichappal.store/fr/products",
    url: "https://peshawarichappal.store/fr/products",
    name: "Outils Mat\xE9riels | Peshawari Chappal",
    description: "Explorez la durabilit\xE9 et la pr\xE9cision des outils Peshawari Chappal, con\xE7us aussi bien pour les professionnels que pour les passionn\xE9s.",
    isPartOf: {
      "@type": "WebSite",
...
}, "/Users/atifjan/PC/pchapp/src/pages/fr/products/index.astro", void 0);

const $$file = "/Users/atifjan/PC/pchapp/src/pages/fr/products/index.astro";
