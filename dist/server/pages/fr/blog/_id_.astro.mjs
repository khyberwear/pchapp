...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const metaDescription = post.data.contents[0] || `Lisez ${post.data.title} sur le blog de Peshawari Chappal`;
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "lang": "fr", "customDescription": metaDescription, "customOgTitle": ogTitle, "structuredData": {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://peshawarichappal.store/fr/blog/${post.id.replace(/^fr\//, "")}`
    },
    inLanguage: "fr"
...
}, "/Users/atifjan/PC/pchapp/src/pages/fr/blog/[id].astro", void 0);

const $$file = "/Users/atifjan/PC/pchapp/src/pages/fr/blog/[id].astro";
