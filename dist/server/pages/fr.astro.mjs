...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "lang": "fr" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AnnouncementBanner", $$AnnouncementBanner, { "btnId": "dismiss-button", "btnTitle": "D\xE9couvrez Peshawari Chappal sur GitHub", "url": "https://github.com/mearashadowfax/Peshawari Chappal" })} ${renderComponent($$result2, "HeroSection", $$HeroSection, { "title": `\xC9quipez vos projets avec <span class="text-yellow-500 dark:text-yellow-400">Peshawari Chappal</span>`, "subTitle": "Outils mat\xE9riels de haute qualit\xE9 et services de construction experts pour tous les besoins en projet.", "primaryBtn": "Commencez \xE0 explorer", "primaryBtnURL": getRelativeLocaleUrl("fr", "products"), "secondaryBtn": "Contacter l'\xE9quipe commerciale", "secondaryBtnURL": getRelativeLocaleUrl("fr", "contact"), "withReview": true, "avatars": avatarSrcs, "rating": `<span class="font-bold">4.8</span> / 5`, "starCount": 4, "reviews": `\xC0 partir de plus de <span class="font-bold">12,8k</span> avis`, "src": heroImage, "alt": "Pile de bo\xEEtes de produits Peshawari Chappal contenant des outils mat\xE9riels assortis" })} ${renderComponent($$result2, "ClientsSection", $$ClientsSection, { "title": "Faites confiance aux leaders de l'industrie", "subTitle": "D\xE9couvrez la fiabilit\xE9 choisie par les g\xE9ants de l'industrie.", "partners": partnersData })} ${renderComponent($$result2, "FeaturesGeneral", $$FeaturesGeneral, { "title": "R\xE9pondre aux exigences de l'industrie", "subTitle": "Chez Peshawari Chappal, nous relevons les d\xE9fis uniques rencontr\xE9s dans les secteurs du mat\xE9riel et de la construction. Des outils de pointe aux services experts, nous sommes d\xE9termin\xE9s \xE0 vous aider \xE0 surmonter les obstacles et \xE0 atteindre vos objectifs.", "src": featureImage, "alt": "Produits Peshawari Chappal dans des bo\xEEtes flottantes", "features": features })} ${renderComponent($$result2, "FeaturesNavs", $$FeaturesNavs, { "title": `Personnalisez les offres de <span class="text-yellow-500 dark:text-yellow-400">Peshawari Chappal</span> pour r\xE9pondre parfaitement \xE0 vos besoins en mat\xE9riel et en construction.`, "tabs": [
    {
      heading: "Outils de pointe",
      content: "Optimisez vos projets avec les outils de pointe de Peshawari Chappal. Faites l'exp\xE9rience d'une efficacit\xE9 accrue dans la gestion de la construction avec nos solutions automatis\xE9es sophistiqu\xE9es.",
      svg: "tools",
      src: tools,
    ...
    },
    {
      ...
      content: "Naviguez facilement avec les tableaux de bord intuitifs de Peshawari Chappal. Configurez et supervisez vos projets de mani\xE8re transparente, avec des interfaces conviviales con\xE7ues pour une gestion efficace des flux de travail rapide et efficace.",
      svg: "dashboard",
      src: dashboard,
    ...
    },
    {
      ...
      content: "Minimisez la complexit\xE9, maximisez la productivit\xE9. Les fonctionnalit\xE9s robustes de Peshawari Chappal sont con\xE7ues pour rationaliser votre processus de construction, offrant des r\xE9sultats qui se distinguent par leur excellence.",
      svg: "house",
      src: construction,
      alt: "Structure m\xE9tallique grise d'un b\xE2timent pr\xE8s d'une grue \xE0 tour pendant la journ\xE9e"
    }
  ] })} ${renderComponent($$result2, "TestimonialsSection", $$TestimonialsSection, { "title": "Acc\xE9l\xE9rez vos projets", "subTitle": "Chez Peshawari Chappal, nous assurons un d\xE9marrage rapide avec une configuration de compte instantan\xE9e. D\xE9couvrez la vitesse de la construction red\xE9finie.", "testimonials": [
    {
      content: "Peshawari Chappal a consid\xE9rablement augment\xE9 l'efficacit\xE9 de notre projet. La configuration a \xE9t\xE9 instantan\xE9e et leurs temps de r\xE9ponse rapides sont ph\xE9nom\xE9naux. Vraiment un changement de jeu dans le support mat\xE9riel et de construction !",
    ...
    {
      count: "35%",
      description: "hausse de l'efficacit\xE9 des projets avec les outils et services de Peshawari Chappal"
    },
    {
      count: "15,3%",
  ...
  ] })} ${renderComponent($$result2, "PricingSection", $$PricingSection, { "pricing": pricing })} ${renderComponent($$result2, "FAQ", $$FAQ, { "title": "Questions<br />fr\xE9quemment pos\xE9es", "faqs": faqs$1 })} ${renderComponent($$result2, "HeroSectionAlt", $$HeroSectionAlt, { "title": "Construisons ensemble", "subTitle": "Peshawari Chappal est un mod\xE8le open source, m\xE9ticuleusement con\xE7u avec les frameworks Astro, Tailwind CSS et Preline UI.", "url": "https://github.com/mearashadowfax/Peshawari Chappal" })} ` })}`;
}, "/Users/atifjan/PC/pchapp/src/pages/fr/index.astro", void 0);

const $$file = "/Users/atifjan/PC/pchapp/src/pages/fr/index.astro";
const $$url = "/fr";
