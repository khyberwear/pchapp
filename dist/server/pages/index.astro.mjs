...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AnnouncementBanner", $$AnnouncementBanner, { "btnId": "dismiss-button", "btnTitle": "Buy Peshawari Chappal", "url": "/products" })} ${renderComponent($$result2, "HeroSection", $$HeroSection, { "title": `Best Peshawari <span
        class="text-yellow-500 dark:text-yellow-400">Chappal</span>`, "subTitle": "Premium leather Peshawari Chappals crafted for all-day comfort & classic appeal.", "primaryBtn": "Shop Now", "primaryBtnURL": "/products", "secondaryBtn": "Contact Us", "secondaryBtnURL": "/contact", "withReview": true, "avatars": avatarSrcs, "rating": `<span class="font-bold">4.8</span> / 5`, "starCount": 4, "reviews": `From Over <span class="font-bold">12.8k</span> Reviews`, "src": heroImage, "alt": "Stack of Peshawari Chappal product boxes containing assorted hardware tools" })} ${renderComponent($$result2, "ClientsSection", $$ClientsSection, { "title": "Trusted by Industry Leaders", "subTitle": "Experience the reliability chosen by industry giants.", "partners": partnersData })} ${renderComponent($$result2, "FeaturesGeneral", $$FeaturesGeneral, { "title": "Meeting Industry Demands", "subTitle": "At Peshawari Chappal, we tackle the unique challenges encountered in the hardware and construction sectors. From cutting-edge tools to expert services, we're dedicated to helping you overcome obstacles and achieve your goals.", "src": featureImage, "alt": "Peshawari Chappal products in floating boxes", "features": features })} ${renderComponent($$result2, "FeaturesNavs", $$FeaturesNavs, { "title": `Customize <span class="text-yellow-500 dark:text-yellow-400">Peshawari Chappal</span>'s offerings to perfectly suit your hardware and construction needs.`, "tabs": [
    {
      heading: "Cutting-Edge Tools",
      content: "Empower your projects with Peshawari Chappal's cutting-edge tools. Experience enhanced efficiency in construction management with our sophisticated automated solutions.",
      svg: "tools",
      src: tools,
    ...
    },
    {
      ...
      content: "Navigate with ease using Peshawari Chappal's intuitive dashboards. Set up and oversee your projects seamlessly, with user-friendly interfaces designed for quick and effective workflow management.",
      svg: "dashboard",
      src: dashboard,
    ...
    },
    {
      ...
      content: "Minimize complexity, maximize productivity. Peshawari Chappal's robust features are engineered to streamline your construction process, delivering results that stand out for their excellence.",
      svg: "house",
      src: construction,
      alt: "Gray metal building frame near tower crane during daytime"
    }
  ] })} ${renderComponent($$result2, "TestimonialsSection", $$TestimonialsSection, { "title": "Fast-Track Your Projects", "subTitle": "At Peshawari Chappal, we ensure a swift start with instant account setup. Experience the speed of construction redefined.", ";": true, "testimonials": [
    {
      content: "Peshawari Chappal dramatically boosted our project efficiency. Setup was instant, and their rapid response times are phenomenal. Truly a game-changer in hardware and construction support!",
    ...
    {
      count: "35%",
      description: "uptick in project efficiency with Peshawari Chappal tools and services"
    },
    {
      count: "15.3%",
  ...
  ] })} ${renderComponent($$result2, "PricingSection", $$PricingSection, { "pricing": pricing })} ${renderComponent($$result2, "FAQ", $$FAQ, { "title": "Frequently<br />asked questions", "faqs": faqs$1 })} ${renderComponent($$result2, "HeroSectionAlt", $$HeroSectionAlt, { "title": "Let's Build Together", "subTitle": "Peshawari Chappal is an open-source template, meticulously crafted with Astro, Tailwind CSS, and Preline UI frameworks.", "url": "https://github.com/mearashadowfax/Peshawari Chappal" })} ` })}`;
