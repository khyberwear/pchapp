import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, d as renderComponent, u as unescapeHTML, F as Fragment, m as maybeRenderHead, g as renderScript, p as renderSlot, s as spreadAttributes, ay as renderHead } from './astro/server_CHNLwNGm.mjs';
import 'kleur/colors';
import { c as getImage } from './_astro_assets_Dr7eqbL5.mjs';
import { c as createSvgComponent } from './runtime_C9TCqpAk.mjs';
...
const $$LoginModal = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(config.id, "id")} class="hs-overlay absolute start-0 top-0 z-50 hidden h-full w-full hs-overlay-backdrop-open:bg-neutral-900/90"> <div class="m-3 mt-0 opacity-0 transition-all ease-out hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:mx-auto sm:w-full sm:max-w-lg"> <div class="mx-auto w-full max-w-md p-6"> <div class="mt-7 rounded-xl border border-neutral-200 bg-neutral-100 shadow-xs dark:border-neutral-700 dark:bg-neutral-800"> <div class="p-4 sm:p-7"> <div class="text-center"> <div class="block text-2xl font-bold text-neutral-800 dark:text-neutral-200" role="heading" aria-level="1"${addAttribute(config.title, "aria-label")}> ${config.title} </div> <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400"> ${config.subTitle} <button class="rounded-lg p-1 font-medium text-orange-400 decoration-2 outline-hidden ring-zinc-500 hover:underline focus-visible:ring-3 dark:text-orange-400 dark:ring-zinc-200 dark:focus:outline-hidden"${addAttribute(config.registerBtnDataHS, "data-hs-overlay")}> ${config.registerBtn} </button> </p> </div> <div class="mt-5"> ${renderComponent($$result, "GoogleBtn", $$GoogleBtn, { "title": "Sign in with Google" })} <div class="flex items-center py-3 text-xs uppercase text-neutral-400 before:me-6 before:flex-[1_1_0%] before:border-t before:border-neutral-200 after:ms-6 after:flex-[1_1_0%] after:border-t after:border-neutral-200 dark:text-neutral-500 dark:before:border-neutral-600 dark:after:border-neutral-600">
Or
</div> <!-- The container for the form --> <form id="login-form"> <!-- A grid layout for the form fields --> <div class="grid gap-y-4"> <!-- The email input field --> ${renderComponent($$result, "EmailInput", $$EmailInput, { "id": "login-email", "errorId": "login-email-error" })} <!-- The password input field --> ${renderComponent($$result, "PasswordInput", $$PasswordInput, { "forgot": true, "id": "password", "errorId": "login-password-error", "content": "8+ characters required" })} <!-- The remember-me checkbox --> ${renderComponent($$result, "Checkbox", $$Checkbox, { "id": "remember-me" })} <!-- The sign-in button --> ${renderComponent($$result, "AuthBtn", $$AuthBtn, { "title": "Sign in" })} </div> </form> </div> </div> </div> </div> </div> </div> ${renderScript($$result, "/Users/atifjan/PC/pchapp/src/components/ui/forms/LoginModal.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/atifjan/PC/pchapp/src/components/ui/forms/LoginModal.astro", void 0);
...
const $$RegisterModal = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Root element of the registration modal with the id and styling -->${maybeRenderHead()}<div${addAttribute(config.id, "id")} class="hs-overlay absolute start-0 top-0 z-50 hidden h-full w-full hs-overlay-backdrop-open:bg-neutral-900/90"> <div class="m-3 mt-0 opacity-0 transition-all ease-out hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:mx-auto sm:w-full sm:max-w-lg"> <div class="mx-auto w-full max-w-md p-6"> <div class="mt-7 max-h-full overflow-hidden rounded-xl border border-neutral-200 bg-neutral-100 shadow-xs dark:border-neutral-700 dark:bg-neutral-800"> <div class="p-4 sm:p-7"> <div class="text-center"> <div class="block text-2xl font-bold text-neutral-800 dark:text-neutral-200" role="heading" aria-level="1"${addAttribute(config.title, "aria-label")}> ${config.title} </div> <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400"> ${config.subTitle} <!-- Button to toggle login modal --> <button class="rounded-lg p-1 font-medium text-orange-400 decoration-2 outline-hidden ring-zinc-500 hover:underline focus-visible:ring-3 dark:text-orange-400 dark:ring-zinc-200 dark:focus:outline-hidden"${addAttribute(config.loginBtnDataHS, "data-hs-overlay")}> ${config.loginBtn} </button> </p> </div> <!-- The form for user registration --> <div class="mt-5"> <!-- Google signup button --> ${renderComponent($$result, "GoogleBtn", $$GoogleBtn, { "title": "Sign up with Google" })} <!-- Dividing line with 'Or' text --> <div class="flex items-center py-3 text-xs uppercase text-neutral-400 before:me-6 before:flex-[1_1_0%] before:border-t before:border-neutral-200 after:ms-6 after:flex-[1_1_0%] after:border-t after:border-neutral-200 dark:text-neutral-500 dark:before:border-neutral-600 dark:after:border-neutral-600">
Or
...
}, "/Users/atifjan/PC/pchapp/src/components/ui/forms/RegisterModal.astro", void 0);
...
const $$RecoverModal = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Root element of the modal with id and styling -->${maybeRenderHead()}<div${addAttribute(config.id, "id")} class="hs-overlay absolute start-0 top-0 z-50 hidden h-full w-full hs-overlay-backdrop-open:bg-neutral-900/90"> <!-- Modal content container --> <div class="m-3 mt-0 opacity-0 transition-all ease-out hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:mx-auto sm:w-full sm:max-w-lg"> <div class="mx-auto w-full max-w-md p-6"> <!-- Actual box for the modal elements --> <div class="mt-7 rounded-xl border border-neutral-200 bg-neutral-100 shadow-xs dark:border-neutral-700 dark:bg-neutral-800"> <div class="p-4 sm:p-7"> <div class="text-center"> <div class="block text-2xl font-bold text-neutral-800 dark:text-neutral-200" role="heading" aria-level="1"${addAttribute(config.title, "aria-label")}> ${config.title} </div> <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400"> ${config.subTitle} <!-- Button that, when clicked, opens the login modal --> <button class="rounded-lg p-1 font-medium text-orange-400 decoration-2 outline-hidden ring-zinc-500 hover:underline focus-visible:ring-3 dark:text-orange-400 dark:ring-zinc-200 dark:focus:outline-hidden"${addAttribute(config.loginBtnDataHS, "data-hs-overlay")}> ${config.loginBtn} </button> </p> </div> <div class="mt-5"> <!-- The form for password recovery --> <form> <div class="grid gap-y-4"> <!-- Email input field imported from EmailInput component --> ${renderComponent($$result, "EmailInput", $$EmailInput, { "id": "recover-email", "errorId": "recover-email-error" })} <!-- Reset password button imported from AuthBtn component --> ${renderComponent($$result, "AuthBtn", $$AuthBtn, { "title": "Reset password" })} </div> </form> </div> </div> </div> </div> </div> </div>`;
}, "/Users/atifjan/PC/pchapp/src/components/ui/forms/RecoverModal.astro", void 0);
...
Logout
</button> </div> </div> </div> <!-- Login Modal --> ${renderComponent($$result, "LoginModal", $$LoginModal, {})} <!-- Register Modal --> ${renderComponent($$result, "RegisterModal", $$RegisterModal, {})} <!-- Password Recovery Modal --> ${renderComponent($$result, "RecoverModal", $$RecoverModal, {})} ${renderScript($$result, "/Users/atifjan/PC/pchapp/src/components/sections/misc/Authentication.astro?astro&type=script&index=0&lang.ts")}`;
...
}, "/Users/atifjan/PC/pchapp/src/components/ui/links/FooterSocialLink.astro", void 0);
...
}, "/Users/atifjan/PC/pchapp/src/components/ui/forms/input/EmailFooterInput.astro", void 0);
...
}, "/Users/atifjan/PC/pchapp/src/components/BrandLogo.astro", void 0);
...
</p> </div> <!-- Social Brands --> <div> ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.facebook }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "facebookFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.x }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "xFooter" })}` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.github }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "githubFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.google }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "googleFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.slack }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "slackFooter" })} ` })} </div> </div> ${renderScript($$result, "/Users/atifjan/PC/pchapp/src/components/sections/navbar&footer/FooterSection.astro?astro&type=script&index=0&lang.ts")} </div> </footer>`;
