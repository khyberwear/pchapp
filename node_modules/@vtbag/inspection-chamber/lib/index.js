...
`)}function pt(){Ct(),At()}function At(){let t=1/Math.max(1e-6,parseFloat(top.document.querySelector("#vtbag-ui-tsf")?.innerText??"1.0"));top.__vtbag.inspectionChamber.animations?.forEach(e=>{e.playbackRate=t,e.playState==="paused"&&e.play()})}function vt(){let t=top.document.querySelector("#vtbag-ui-slo-mo"),e=top.document.querySelector("#vtbag-ui-tsf");t.addEventListener("input",n=>{if(n.target instanceof HTMLInputElement){let o=(Math.exp(parseInt(n.target.value,10)/100)-100)/100+1-.14;e.innerText=`${o.toFixed(1)}`,At()}})}function Ct(){let t=top.__vtbag.inspectionChamber,e=t.longestAnimation;e&&(top.document.querySelector("#vtbag-ui-slo-mo-progress").innerText=` ${~~(e.currentTime??0)} / ${t.animationEndTime} ms`,b()&&top.setTimeout(Ct,20))}var Mt=[],oe=["top","left","right","bottom"];var bt;function yt(t){bt??=ae();let e=[];return e.push("inset"),Mt.forEach(n=>{t.getPropertyValue(n)!==bt[n]&&e.push(n)}),e.filter(n=>!(n.startsWith("inset-")||n.startsWith("animation-")||oe.includes(n)))}function ae(){let t=top.document.createElement("div");top.document.body.appendChild(t);let e=top.getComputedStyle(t),n={};for(let o=0;o<e.length;o++){let i=e.item(o);Mt.push(i),n[i]=e.getPropertyValue(i)}return top.document.body.removeChild(t),n}function ht(t,e,n,o,i){let a=e.createElement("vtbag-pseudo-twin");d(a,t,"::view-transition","");let g=top.__vtbag.inspectionChamber.twin=a.firstElementChild;n.forEach(c=>{let s=d(g,t,"group",c),l=d(s,t,"image-pair",c);d(l,t,"old",c)&&o.add(c),d(l,t,"new",c)&&i.add(c)}),e.body.insertAdjacentElement("beforeend",g);function d(c,s,l,u){if(!c){console.error("[inspection chamber] Works not as expected ;-)");return}let A=top.__vtbag.inspectionChamber,r=c.ownerDocument,p=s.defaultView,I=u?`::view-transition-${l}(${u})`:l,C=p.getComputedStyle(s.documentElement,I);if(!C.height.endsWith("px"))return;A?.styleMap.set(u?`${l}-${u}`:l,C);let v=r.createElement("vtbag-pseudo-twin");return v.id=re(u,l),v.dataset.vtbagTransitionName=u,v.dataset.vtbagTransitionPseudo=l,c.insertAdjacentElement("beforeend",v),Lt(C,v.style),v.style.visibility="hidden",v}}function re(t,e){return t?`vtbag-twin--view-transition-${e}-${t}`:"vtbag-twin--view-transition"}async function ft(t){top.document.documentElement.classList.add("vtbag-twin-sync");let e=top.__vtbag.inspectionChamber,n=e.frameDocument.documentElement;for(let o of[...e.twin?.children||[]]){let i=o.dataset.vtbagTransitionName;t.has(i)||(O(o,i),O(o.children[0],i),O(o.children[0].children[0],i),O(o.children[0].children[1],i),await new Promise(a=>self.setTimeout(a)))}top.document.documentElement.classList.remove("vtbag-twin-sync")}function O(t,e){if(!t)return;let n=t.dataset.vtbagTransitionPseudo,o=top.__vtbag.inspectionChamber.styleMap.get(`${n}-${e}`),i=t.style;Lt(o,i)}function Lt(t,e){e.position=t.position,e.inset=t.inset,e.height=t.height,e.width=t.width,e.transform=t.transform,e.zIndex=t.zIndex,e.transformOrigin=t.transformOrigin,e.perspective=t.perspective}function wt(t){if(b()){let e,n=1/0;top.__vtbag.inspectionChamber.twin?.querySelectorAll("vtbag-pseudo-twin > vtbag-pseudo-twin > vtbag-pseudo-twin > vtbag-pseudo-twin").forEach(o=>{let{clientX:i,clientY:a}=t,{top:g,bottom:d,left:c,right:s,width:l,height:u}=o.getBoundingClientRect(),A=o.dataset.vtbagTransitionName,r=o.dataset.vtbagTransitionPseudo;if(l&&u&&l*u<n&&g<=a&&a<=d&&c<=i&&i<=s){let p=!0,I;window.top.document.querySelectorAll("#vtbag-ui-names li").forEach(C=>{C.innerText===A&&(I=C,C.classList.contains(`${r}-hidden`)&&(p=!1))}),p&&(n=l*u,e=I)}}),e?.click()}}function V(){top.document.querySelector('#vtbag-ui-filter input[type="text"]').value="",top.document.querySelector("#vtbag-ui-filter ul input").click(),H()}function Tt(){top.document.querySelectorAll("#vtbag-ui-names li").forEach(t=>t.classList.remove("selected","old-hidden","new-hidden")),x(),xt(),Q()}function St(){top.document.querySelector("#vtbag-ui-filter ul").addEventListener("change",H),top.document.querySelector('#vtbag-ui-filter input[type="text"]').addEventListener("input",H),top.document.querySelector("#vtbag-ui-filter button").addEventListener("click",V)}var jt=500;function U(t,e,n){return h(()=>{top.document.querySelector("#vtbag-ui-info").innerHTML="",top.document.querySelectorAll("#vtbag-ui-names li").forEach(i=>i.remove()),top.document.querySelector("#vtbag-ui-names h4").innerText=e?"Animation Groups":"Elements w/ View Transition Names",top.document.querySelector("#vtbag-ui-names div").style.display=e?"flex":"none";let o=top.document.querySelector("#vtbag-ui-names > ol");(e?n:[...t].sort()).forEach((i,a)=>{let g=top.document.createElement("li");g.innerText=i,e&&t.has(i)&&g.classList.add("old"),e?.has(i)&&g.classList.add("new"),o.appendChild(g)}),top.document.querySelector("#vtbag-ui-filter ul").style.display=e?"block":"none",H()},"update names"),n}function H(){let t=top.document.querySelectorAll("#vtbag-ui-names li"),e=top.document.querySelector("#vtbag-ui-filter ul input:checked").id.replace("vtbag-c-",""),n=top.document.querySelector('#vtbag-ui-filter input[type="text"]').value;h(()=>{t.forEach(o=>{let i=o.style,a=o.classList,g=o.innerText;i.display=(n===""||g.includes(n))&&(e==="all"||e==="both"&&a.contains("new")&&a.contains("old")||e==="old-only"&&a.contains("old")&&!a.contains("new")||e==="new-only"&&a.contains("new")&&!a.contains("old")||e==="old"&&a.contains("old")||e==="new"&&a.contains("new"))?"list-item":"none"})},"refresh names")}async function q(){if(!b())return;let e=top.__vtbag.inspectionChamber.twin?.ownerDocument,n=top.document,o=top.getComputedStyle(n.documentElement),i=n.documentElement.classList.contains("vtbag-ui-column"),a=i?parseFloat(o.getPropertyValue("--vtbag-panel-width")||"0"):0,g=i?0:parseFloat(o.getPropertyValue("--vtbag-panel-height")||"0"),d=n.querySelectorAll("#vtbag-ui-names li"),c=new Set;d.forEach(s=>{s.classList.contains("old-hidden")&&s.classList.contains("new-hidden")&&c.add(s.innerText)}),await ft(c),e&&d.forEach(s=>{let l=s.innerText,u=s.classList;u[u.contains("old")&&Et(e.querySelector(`#vtbag-twin--view-transition-old-${l}`),a,g)===!1?"add":"remove"]("old-invisible"),u[u.contains("new")&&Et(e.querySelector(`#vtbag-twin--view-transition-new-${l}`),a,g)===!1?"add":"remove"]("new-invisible"),u[(!u.contains("old")||u.contains("old-invisible"))&&(!u.contains("new")||u.contains("new-invisible"))?"add":"remove"]("invisible")})}function Et(t,e=0,n=0){if(!t)return;let{top:o,right:i,bottom:a,left:g,width:d,height:c}=t.getBoundingClientRect();return!1,d>0&&c>0&&o<window.top.innerHeight-n&&a>0&&g<window.top.innerWidth-e&&i>0}function x(){let t=[],e=y();!e||e==="bypass"||(top.document.querySelectorAll("#vtbag-ui-names li").forEach(n=>{let o=n.innerText,i=n.classList,a=!0,g=!0;i.contains("old-hidden")?(a=!1,t.push(`::view-transition-old(${o}) { visibility: hidden; }`)):i.contains("old")||(a=!1),i.contains("new-hidden")?(t.push(`::view-transition-new(${o}) { visibility: hidden; }`),g=!1):i.contains("new")||(g=!1),!a&&!g&&t.push(`::view-transition-group(${o}) { visibility: hidden; }`)}),L(t.join(`
`),"image-visibility"),f())}function ge(t){let e=y()==="full-control"&&b(),n=top.document.querySelectorAll("#vtbag-ui-names li"),o,i=top.document.querySelector("#vtbag-ui-controller"),a=top.document.querySelector("#vtbag-ui-progress"),g=top.document.querySelector("#vtbag-ui-controller2"),d=top.document.querySelector("#vtbag-ui-progress2");n.forEach(c=>{c.innerText===t?(c.classList.contains("selected")?(g.value=i.value,d.innerText=a.innerText):(i.value=g.value,a.innerText=d.innerText),c.classList[e?"toggle":"add"]("selected"),o=c,c.style.display==="none"&&V()):e||c.classList.remove("selected")}),o&&o.scrollIntoView({behavior:"instant",block:"nearest",inline:"nearest"})}function le(t){let e=top.document.querySelector("#vtbag-ui-info");if(t&&!b())navigator.clipboard.writeText(`inspect(top.document.querySelector("#vtbag-main-frame").contentDocument.querySelector("${Nt(t)}"))`),e.innerHTML=`<h4>Info</h4>
