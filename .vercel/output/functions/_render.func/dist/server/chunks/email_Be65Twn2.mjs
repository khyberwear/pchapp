...
function getStatusEmailContent(status, data) {
  const itemsList = data.items.map((item) => `<tr>
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f5f5f5;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="background-color: #1f2937; padding: 30px; text-align: center;">
            ...
            <p style="color: #6b7280; margin: 0; font-size: 12px;">© ${(/* @__PURE__ */ new Date()).getFullYear()} Peshawari Chappal. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
...
async function sendOrderStatusEmail(data) {
  ...
  try {
    const callback = function(error, data2, response) {
      if (error) {
...
export { sendAdminNotification as a, sendCustomerConfirmation as b, sendOrderStatusEmail as s };
