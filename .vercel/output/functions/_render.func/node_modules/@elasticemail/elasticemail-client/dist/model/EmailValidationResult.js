...
var _EmailPredictedValidationStatus = _interopRequireDefault(require("./EmailPredictedValidationStatus"));
...
var EmailValidationResult = /*#__PURE__*/function () {
   ...
   */
  return _createClass(EmailValidationResult, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('PredictedScore')) {
          obj['PredictedScore'] = _ApiClient["default"].convertToType(data['PredictedScore'], 'Number');
        }
        if (data.hasOwnProperty('PredictedStatus')) {
          obj['PredictedStatus'] = _EmailPredictedValidationStatus["default"].constructFromObject(data['PredictedStatus']);
        }
      }
      return obj;
    }
...
var _default = exports["default"] = EmailValidationResult;