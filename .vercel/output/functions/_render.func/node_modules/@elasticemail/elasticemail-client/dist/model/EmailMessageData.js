...
var EmailMessageData = /*#__PURE__*/function () {
   ...
   */
  function EmailMessageData(recipients, content) {
   ...
   */
  return _createClass(EmailMessageData, null, [{
    key: "initialize",
    value: function initialize(obj, recipients, content) {
      ...
      if (data['Recipients']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _EmailRecipient["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = EmailMessageData;