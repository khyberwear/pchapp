...
import { c as createExports } from './chunks/entrypoint_B6UVV_Tm.mjs';
import { manifest } from './manifest_DcgsNu5T.mjs';
...
const _page12 = () => import('./pages/manifest.json.astro.mjs');
const _page13 = () => import('./pages/products/_id_.astro.mjs');
const _page14 = () => import('./pages/products.astro.mjs');
const _page15 = () => import('./pages/robots.txt.astro.mjs');
const _page16 = () => import('./pages/services.astro.mjs');
const _page17 = () => import('./pages/settings.astro.mjs');
const _page18 = () => import('./pages/sitemap.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/manifest.json.ts", _page12],
    ["src/pages/products/[id].astro", _page13],
    ["src/pages/products/index.astro", _page14],
    ["src/pages/robots.txt.ts", _page15],
    ["src/pages/services.astro", _page16],
    ["src/pages/settings.astro", _page17],
    ["src/pages/sitemap.astro", _page18],
...
const _args = {
    "middlewareSecret": "1f112a5c-9761-42c6-88a4-67d2f785fe36",
