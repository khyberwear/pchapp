...
const $$Meta = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${structuredData && renderTemplate(_a$2 || (_a$2 = __template$2(['<script type="application/ld+json">', "<\/script>"])), unescapeHTML(JSON.stringify(structuredData)))}<meta charset="utf-8"><meta${addAttribute(description, "content")} name="description"><meta name="web_author"${addAttribute(author, "content")}><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0, minimum-scale=1.0"><meta http-equiv="X-UA-Compatible" content="ie=edge"><link rel="canonical"${addAttribute(canonical, "href")}>${renderComponent($$result, "Fragment", Fragment, {}, { "default": async ($$result2) => renderTemplate`${unescapeHTML(alternateLanguageLinks)}` })}<meta property="og:locale" content="en_US"><meta property="og:url"${addAttribute(URL, "content")}><meta property="og:type" content="website"><meta property="og:title"${addAttribute(ogTitle, "content")}><meta property="og:site_name"${addAttribute(SITE.title, "content")}><meta property="og:description"${addAttribute(ogDescription, "content")}><meta property="og:image"${addAttribute(socialImage, "content")}><meta content="1200" property="og:image:width"><meta content="600" property="og:image:height"><meta content="image/png" property="og:image:type"><meta name="twitter:card" content="summary_large_image"><meta property="twitter:domain"${addAttribute(URL, "content")}><meta property="twitter:url"${addAttribute(URL, "content")}><meta name="twitter:title"${addAttribute(ogTitle, "content")}><meta name="twitter:description"${addAttribute(ogDescription, "content")}><meta name="twitter:image"${addAttribute(socialImage, "content")}><link rel="manifest" href="/manifest.json"><link rel="sitemap" href="/sitemap-index.xml"><link href="/favicon.jpeg?v=20241201" rel="icon" type="image/jpeg" sizes="32x32"><link href="/favicon.jpeg?v=20241201" rel="shortcut icon" type="image/jpeg"><link href="/favicon.jpeg?v=20241201" rel="apple-touch-icon" type="image/jpeg" sizes="180x180"><link href="/favicon.jpeg?v=20241201" rel="icon" type="image/jpeg" sizes="16x16"><link href="/favicon.jpeg?v=20241201" rel="icon" type="image/jpeg" sizes="32x32"><link href="/favicon.jpeg?v=20241201" rel="icon" type="image/jpeg" sizes="192x192"><link href="/favicon.jpeg?v=20241201" rel="icon" type="image/jpeg" sizes="512x512"><link${addAttribute(faviconSvg.src, "href")} rel="icon" type="image/svg+xml" sizes="any"><meta name="mobile-web-app-capable" content="yes"><link${addAttribute(appleTouchIcon.src, "href")} rel="apple-touch-icon"><meta name="theme-color" content="#facc15">`;
...
const $$Authentication = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Auth container removed - login is manual via /login page for admin only -->`;
...
const $$FloatingWhatsApp = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="floating-whatsapp" class="fixed bottom-6 right-6 z-[9999] group" style="opacity: 1; pointer-events: auto;" data-astro-cid-ce2tfxup> <a href="https://wa.me/923001234567?text=Hi%2C%20I%20would%20like%20to%20know%20more%20about%20your%20products" target="_blank" rel="noopener noreferrer" class="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-2xl" aria-label="Chat on WhatsApp" data-astro-cid-ce2tfxup> <svg class="h-7 w-7" fill="currentColor" viewBox="0 0 24 24" data-astro-cid-ce2tfxup> <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488" data-astro-cid-ce2tfxup></path> </svg> <!-- Pulse animation ring --> <span class="absolute -inset-1 rounded-full bg-[#25D366] opacity-75 animate-ping" data-astro-cid-ce2tfxup></span> </a> <!-- Tooltip --> <div class="absolute bottom-full right-0 mb-2 hidden whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm text-white shadow-lg group-hover:block dark:bg-white dark:text-gray-900" data-astro-cid-ce2tfxup>
Chat with us on WhatsApp
<div class="absolute -bottom-1 right-4 h-2 w-2 rotate-45 bg-gray-900 dark:bg-white" data-astro-cid-ce2tfxup></div> </div> </div>  ${renderScript($$result, "/Users/atifjan/PC/pchapp/src/components/FloatingWhatsApp.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/atifjan/PC/pchapp/src/components/FloatingWhatsApp.astro", void 0);
